...
const Video: React.FC = () => {
  return (
    <section className="pt-8 pb-20 md:pt-5 md:pb-10 px-10 flex items-center justify-center bg-gradient-to-r from-indigo-400 to-cyan-400 text-white font-semibold">
